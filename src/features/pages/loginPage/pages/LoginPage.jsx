                ...
                <div className="flex-1 p-12 bg-neutral-800/30 flex flex-col justify-center">
                    ...
                    <ul className="space-y-4 text-gray-400">
                        <li className="flex items-center gap-2">
                            <CheckIcon /> <span><strong className="text-gray-200 font-medium">Light/dark</strong> mode toggle</span>
                        </li>
                        <li className="flex items-center gap-2">
                            <CheckIcon /> <span><strong className="text-gray-200 font-medium">Redux toolkit</strong> and other utility libraries configured</span>
                        </li>
                        <li className="flex items-center gap-2">
                            <CheckIcon /> <span><strong className="text-gray-200 font-medium">Calendar, Modal, Sidebar</strong> components</span>
                        </li>
                        <li className="flex items-center gap-2">
                            <CheckIcon /> <span>User-friendly <strong className="text-gray-200 font-medium">documentation</strong></span>
                        </li>
                        <li className="flex items-center gap-2">
                            <CheckIcon /> <span><strong className="text-gray-200 font-medium">Daisy UI</strong> components, <strong className="text-gray-200 font-medium">Tailwind CSS</strong> support</span>
                        </li>
                    </ul>
                </div>
\
